from src.challenges.intstants import instant_loom, instant_barracks, delete_starting_scout, \
    delete_starting_vills
from src.challenges.other import max_vills_in_dark_age, no_extra_tcs, kill_vills_when_housed, max_pop, \
    no_relics, delay_age_until_solo_aged
from src.challenges.resources import no_forage_bush, no_stone, no_hunt, no_mills, send_sheep_to_solo, \
    no_sheep
from src.challenges.techs import no_current_age_blacksmith_techs, get_all_blacksmith_techs, \
